...
import com.revature.p2.services.OffenseService;
	...
	public class OffenseController {
		...
		public void updateOffenseInfo(@RequestBody Offense updateOffense) {

			offenseService.updateOffense(updateOffense);
		}
		
		@DeleteMapping("/delete")
		@ResponseStatus(HttpStatus.OK)
		public void deleteOffenseById(Offense deleteOffense) {
			offenseService.deleteOffenseById(deleteOffense.getId());
		}
