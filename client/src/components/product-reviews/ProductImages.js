                ...
                {[12].map((e, i) => {
                    ...
                    return (<Col key={`imc-${i}`} lg={e}>
                        <Card key={`imca-${i}`} style={{ height: '100%' }}>
                            {/* <Image key={`im-${i}`} src={`${pics[currentPic].src}`} /> */}
                            <Image key={`img-${i}`} src={`${pics[randNum + i].src}`} />
                            <Card.Body>
                                {/* <Card.Title>{`${pics[currentPic].src}`}</Card.Title> */}
                            </Card.Body>
                        </Card>
                    </Col>)
                })}
                ...
                {[3, 3, 3, 3].map((e, i) => {
                    return (<Col key={`imc2-${i}`} lg={e}>
                        ...
                        <Card key={`imca2-${i}`} style={{ height: '100%' }}>
                            <Image onClick={() => setCurrentPic(randNum + i)} key={`im2-${i}`} src={`${pics[randNum + i].src}`} />
                            {/* <Card.Body>
                                <Card.Title>{`${pics[randNum].src}`}</Card.Title>
                            </Card.Body> */}
                        </Card>
                    </Col>)
                })}
